...
* *Lasers, cours et exercice* DANGOISSE, ed DUNOD (section 8.3.3)
...
Ou alors on peut présenter l'effet Compton qui est une confirmation de la notion de photon introduite par Einstein, fait dans le ASLANGUL.

On peut sinon parler de **source de photons unique** et mettre l'application du refroidissement Doppler dans la partie sur l'impulsion

# Conclusion 
Aspect ondulatoire de la lumière
[Interférences](https://www.youtube.com/watch?v=PaTgZrc5iYk)
